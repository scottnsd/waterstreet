...
2. Search for `waterstreet_` for to capture all the function names
...
* Search for: `'waterstreet'` & replace with: `'megatherium'`
* Search for: `waterstreet_` & replace with: `megatherium_`
